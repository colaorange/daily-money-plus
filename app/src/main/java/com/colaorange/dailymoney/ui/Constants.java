...
public class Constants {
    ...
    public static final String PREFS_AUTO_BACKUP_AT_HOURS = "auto_backup_at_hours";
    public static final String PREFS_AUTO_BACKUP_WEEK_DAYS = "auto_backup_week_days";
}
