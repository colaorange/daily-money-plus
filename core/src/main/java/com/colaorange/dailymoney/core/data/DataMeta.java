...
public class DataMeta {
    ...
    public static final String COL_ACC_PRIORITY = "pr_";

    public static final String[] COL_ACC_ALL = new String[]{COL_ACC_ID, COL_ACC_NAME, COL_ACC_TYPE, COL_ACC_CASHACCOUNT, COL_ACC_INITVAL, COL_ACC_PRIORITY};
